...
//                     |> Seq.map(fun item -> {|AccountName = item.AccountName; Schedules = item.Schedules|} )
////         let actual = response |> Seq.collect(fun x ->
////                  x.Result
////                  |> Seq.map(fun i -> {| AccountName = x.AccountName; Schedules = i.Schedules|}))
//         let expected = seq {
...
//             {| AccountName =  "hud-innovation-dev"; Schedules = "{\"dev\":{\"start\":true,\"stop\":true}}"|}
//             {| AccountName =  "hud-innovation-dev"; Schedules = "{\"dev\":{\"start\":true,\"stop\":true}}"|}
//             {| AccountName =  "hud-onap-nonprod"; Schedules = "{\"onap-dev\":{\"start\":true,\"stop\":true},\"onap-int\":{\"start\":true,\"stop\":true},\"onap-test\":{\"start\":true,\"stop\":true}}"|}
//             {| AccountName =  "hud-onap-nonprod"; Schedules = "{\"onap-dev\":{\"start\":true,\"stop\":true},\"onap-int\":{\"start\":true,\"stop\":true},\"onap-test\":{\"start\":true,\"stop\":true}}"|}
//             {| AccountName =  "hud-onap-nonprod"; Schedules = "{\"onap-dev\":{\"start\":true,\"stop\":true},\"onap-int\":{\"start\":true,\"stop\":true},\"onap-test\":{\"start\":true,\"stop\":true}}"|}
//             {| AccountName =  "hud-onap-nonprod"; Schedules = "{\"onap-dev\":{\"start\":true,\"stop\":true},\"onap-int\":{\"start\":true,\"stop\":true},\"onap-test\":{\"start\":true,\"stop\":true}}"|}
//             {| AccountName =  "hud-onap-nonprod"; Schedules = "{\"onap-dev\":{\"start\":true,\"stop\":true},\"onap-int\":{\"start\":true,\"stop\":true},\"onap-test\":{\"start\":true,\"stop\":true}}"|}
